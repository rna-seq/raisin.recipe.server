...
def supervisord_conf(buildout_directory):
    path = os.path.join(buildout_directory, 'etc/supervisor')
    if not os.path.exists(path):
        os.makedirs(path)
    path = os.path.join(buildout_directory, 'etc/supervisor/supervisord.conf')
    if not os.path.exists(path):
        conf = open(path, 'w')
        ...
        path = os.path.join(buildout_directory, "bin/paster")
        config_file = os.path.join(buildout_directory, "etc/restish/development.ini")
        conf.write("""command = %s serve %s\n""" % (path, config_file))
        ...
        path = os.path.join(buildout_directory, "bin/paster")
        config_file = os.path.join(buildout_directory, "etc/pyramid/development.ini")
        conf.write("""command = %s serve %s\n""" % (path, config_file))
...
def main(buildout, buildout_directory, staging):
    ...
    supervisord_conf(buildout_directory)
